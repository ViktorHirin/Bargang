...
export default function Roadmap() {
  return (
    <div id="roadmap">
      <Container>
        <h2 className="mt-5 text-orange font-xxxl" style={{textAlign: 'center', fontWeight : 'bold'}}>LANUCH ROADMAP</h2>
        <span className="white-divider"></span>
        <p className="mt-3 mb-0 text-white font-xl" style={{textAlign: 'center'}}>As we value our community and its creativity,</p>
        <p className="text-white font-xl" style={{textAlign: 'center'}}>our roadmap will be updated according to your comments and ideas.</p>
        <RoadmapStep        
          progress={1}
          percent="10%"
          title="GRAND OPENING"
